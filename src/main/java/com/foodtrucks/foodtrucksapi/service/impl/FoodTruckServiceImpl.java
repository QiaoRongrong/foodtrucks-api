...
public class FoodTruckServiceImpl implements FoodTruckService {
    ...
    @Override
    public Flux<FoodTruckVo> getFoodTruck(String address, Pageable pageable) {
        return Flux.fromIterable(
                foodTruckRepository.findAllByAddressContains(address, pageable)
                        .stream()
    ...
    @Override
    public Flux<FoodTruck> getRawFoodTrucks(Pageable pageable) {
        return Flux.fromIterable(foodTruckRepository.findAll(pageable));
    }
